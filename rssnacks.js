...
pt1.onclick = function(){
    ...
    setTimeout(
        function(){
            ...
            carousel.style["background-image"] = "url('https://saswatdeadpool.site.live/img/uJhCn-Sx8kE-Ok4Fj-KtoHu-oQDjC.jpeg')" ;
            carousel.animate(
                show,
                {
                    duration : 800,
...
pt2.onclick = function(){
    ...
    setTimeout(
        function(){
            carousel.style["opacity"] = "0.1" ;
            carousel.style["background-image"] = "url('https://saswatdeadpool.site.live/img/HlSKK-VW8lf-fTZMi-VhFFz-M3X4m.jpeg')" ;
            carousel.animate(
                show,
                {
                    duration : 800,
...
pt3.onclick = function(){
    ...
    setTimeout(
        function(){
            carousel.style["opacity"] = "0.1" ;
            carousel.style["background-image"] = "url('https://saswatdeadpool.site.live/img/96TX1-6YEdw-NBT81-A3CEx-znM5m.jpeg')" ;
            carousel.animate(
                show,
                {
                    duration : 800,
